...
3.	When the build finishes, Xcode’s Organizer will open with your archive.
4.	Right-click the archive and click Show in Finder.
...
1.	In Finder, select an .fdx file (or whatever UTI you support).
2.	Press Spacebar (Quick Look).
3.	Your PreviewProvider should be invoked and render HTML.
